...
The app automatically deploys on AWS ElasticBeanstalk on each merge to the `master` branch
and available by the URL: [toko-app-dev.us-east-1.elasticbeanstalk.com](http://toko-app-dev.us-east-1.elasticbeanstalk.com/) 
